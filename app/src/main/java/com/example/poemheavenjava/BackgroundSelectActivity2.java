...
import static com.example.poemheavenjava.AnimationRequestActivity.CHOOSE_PHOTO;
...
public class BackgroundSelectActivity2 extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
...
//                    .setBackgroundColor(getResources().getColor(R.color.shallow_black, null))
            ...
            if (ContextCompat.checkSelfPermission(BackgroundSelectActivity2.this, android.Manifest.permission.READ_MEDIA_IMAGES) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(BackgroundSelectActivity2.this, new String[]{ Manifest.permission. READ_MEDIA_IMAGES }, 1);
            } else {
                openAlbum();
            }
